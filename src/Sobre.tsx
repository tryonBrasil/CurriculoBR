...
const Sobre: React.FC<SobreProps> = ({ onVoltar, onCriarCurriculo }) => {
  ...
  const features = [
    ...
    { icon: 'fa-bolt', title: 'Zero Fricção', desc: 'Sem cadastro, sem etapas desnecessárias. Abriu o site, já pode começar. Em minutos você tem um currículo profissional. Modelos premium a partir de R$9,90.', color: 'bg-amber-50 dark:bg-amber-900/20 text-amber-600' },
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-900 flex flex-col">
      ...
      <section className="relative py-20 px-6 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <p className="text-lg text-slate-500 dark:text-slate-400 max-w-2xl mx-auto leading-relaxed">
            O CurrículoGO nasceu da crença de que um currículo profissional de qualidade não deve ser privilégio de poucos. Construímos a ferramenta que queríamos ter quando buscávamos emprego.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-slate-600 dark:text-slate-400 leading-relaxed mb-4">Plataformas pagas cobram mensalidades absurdas por algo simples: um currículo bem feito. O CurrículoGO prova que dá pra fazer isso gratuitamente, com mais qualidade, mais privacidade e mais inteligência.</p>
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-blue-600 to-indigo-600 rounded-3xl p-8 text-white relative overflow-hidden">
                ...
                <p className="mt-4 text-blue-200 text-sm font-bold uppercase tracking-widest">— Equipe CurrículoGO</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 border border-green-200 dark:border-green-700/40 rounded-3xl p-10 flex gap-8 items-start">
            ...
            <div>
              ...
              <p className="text-slate-600 dark:text-slate-400 leading-relaxed">Quando você usa os recursos de IA, os trechos do currículo são enviados diretamente para a API do Google Gemini — sem passar pelo CurrículoGO. Seu currículo é realmente seu.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <footer className="border-t border-slate-200 dark:border-slate-800 py-8 text-center text-xs text-slate-400 dark:text-slate-600">
        © {new Date().getFullYear()} CurrículoGO — Todos os direitos reservados.
      </footer>
    </div>
  );
};
