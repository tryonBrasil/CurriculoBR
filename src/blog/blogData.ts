...
export const BLOG_POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    content: `
      ...
      <h2>Conclusão</h2>
      <p>Evitar esses erros não garante o emprego, mas garante que seu currículo chegue onde deveria: nas mãos de quem toma a decisão. Use o <strong>CurrículoGO</strong> para criar um currículo profissional que já evita esses problemas por design.</p>
    `,
  },
  {
  ...
  },
  {
    ...
    content: `
      ...
      <h2>Conclusão</h2>
      <p>Em tecnologia, a prática fala mais alto que o diploma. Um currículo de TI forte é aquele que comprova o que afirma — com links, projetos e números reais. Use o <strong>CurrículoGO</strong> para montar sua estrutura e deixe seu GitHub e portfólio fazerem o resto.</p>
    `,
  },
  {
    ...
    content: `
      ...
      <p>Mantenha um "currículo master" com todas as suas experiências e habilidades. Para cada candidatura importante, crie uma versão adaptada a partir dele. O <strong>CurrículoGO</strong> facilita esse processo — você pode ajustar o conteúdo rapidamente e baixar uma nova versão em PDF a qualquer momento.</p>
  ...
  },
  {
    ...
    content: `
      ...
      <p>Sempre envie o currículo em <strong>.PDF</strong> gerado por um editor de texto (como o CurrículoGO) ou em <strong>.DOCX</strong>. PDFs escaneados de documentos físicos são essencialmente imagens — o ATS não consegue ler o texto.</p>
      ...
      <p>Um layout de coluna única é o mais seguro para ATS. Se usar duas colunas (como nos templates do CurrículoGO), prefira designs que exportam o PDF com texto linear e sem caixas flutuantes. O CurrículoGO gera PDFs compatíveis com ATS exatamente por isso.</p>
      ...
      <h2>Score ATS do CurrículoGO</h2>
      <p>O CurrículoGO possui uma ferramenta exclusiva de <strong>Score ATS com Inteligência Artificial</strong>. Ela analisa seu currículo e retorna:</p>
      <ul>
      ...
      <p>Para acessar, crie ou edite seu currículo no CurrículoGO e clique no botão <strong>"Score ATS"</strong> no menu superior. A análise é feita pelo Google Gemini e leva apenas alguns segundos.</p>
