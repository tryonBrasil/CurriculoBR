...
export const BLOG_POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    content: `
      ...
      <h2>Conclusão</h2>
      <p>Evitar esses erros não garante o emprego, mas garante que seu currículo chegue onde deveria: nas mãos de quem toma a decisão. Use o <strong>CurriculoGO</strong> para criar um currículo profissional que já evita esses problemas por design.</p>
    `,
  },
  {
  ...
  },
  {
    ...
    content: `
      ...
      <h2>Conclusão</h2>
      <p>Em tecnologia, a prática fala mais alto que o diploma. Um currículo de TI forte é aquele que comprova o que afirma — com links, projetos e números reais. Use o <strong>CurriculoGO</strong> para montar sua estrutura e deixe seu GitHub e portfólio fazerem o resto.</p>
    `,
  },
  {
    ...
    content: `
      ...
      <p>Mantenha um "currículo master" com todas as suas experiências e habilidades. Para cada candidatura importante, crie uma versão adaptada a partir dele. O <strong>CurriculoGO</strong> facilita esse processo — você pode ajustar o conteúdo rapidamente e baixar uma nova versão em PDF a qualquer momento.</p>
  ...
  {
    slug: 'o-que-e-ats-e-como-passar-pela-triagem',
    title: 'O Que é ATS e Como Fazer seu Currículo Passar pela Triagem Automática',
    description: 'Descubra como funcionam os sistemas ATS usados pelas grandes empresas, quais erros eliminam seu currículo automaticamente e como otimizar cada seção para passar pela triagem.',
    category: 'ATS & Tech',
    readTime: '9 min',
    date: '25 de fevereiro de 2026',
    content: `
      <p>Você enviou seu currículo, tem a experiência certa, as qualificações certas — e mesmo assim não recebeu nenhum retorno. Isso acontece com milhões de candidatos todos os anos, e a razão muitas vezes não é a falta de qualificação: é o <strong>ATS</strong>.</p>

      <h2>O Que é ATS?</h2>
      <p>ATS significa <em>Applicant Tracking System</em> — em português, Sistema de Rastreamento de Candidatos. É um software usado por empresas de médio e grande porte para <strong>receber, organizar, filtrar e classificar currículos</strong> automaticamente, antes de qualquer olho humano ver o documento.</p>
      <p>Estima-se que <strong>mais de 98% das empresas Fortune 500</strong> usem algum tipo de ATS, e no Brasil essa adoção cresce rapidamente em empresas com mais de 200 funcionários. Plataformas como Greenhouse, Workday, SAP SuccessFactors, Gupy e Kenoby são algumas das mais comuns no mercado brasileiro.</p>
      <p>O funcionamento básico é simples: quando você envia seu currículo por um portal de vagas, o ATS escaneia o documento, extrai as informações (nome, contato, experiências, formação, habilidades) e pontua seu perfil com base nas palavras-chave e requisitos da vaga. Currículos abaixo de uma pontuação mínima são automaticamente descartados — sem que nenhum recrutador tenha lido uma linha.</p>

      <h2>Como o ATS Lê seu Currículo</h2>
      <p>Entender o que o ATS analisa é o primeiro passo para otimizar seu currículo:</p>
      <ul>
        <li><strong>Palavras-chave:</strong> O ATS compara o conteúdo do currículo com a descrição da vaga. Quanto mais termos em comum, maior a pontuação. Por isso, palavras-chave específicas da área são fundamentais.</li>
        <li><strong>Estrutura do documento:</strong> O sistema tenta identificar seções padrão como "Experiência Profissional", "Formação Acadêmica" e "Habilidades". Títulos de seção muito criativos ou incomuns podem confundir o ATS.</li>
        <li><strong>Formatação:</strong> Tabelas complexas, cabeçalhos e rodapés, caixas de texto e imagens com texto embutido frequentemente não são lidos corretamente. O ATS prefere texto simples e linear.</li>
        <li><strong>Datas:</strong> O ATS extrai períodos de trabalho e educação para calcular tempo de experiência. Formatos inconsistentes (misturar "jan/2020" com "01-2020") podem causar erros de leitura.</li>
        <li><strong>Informações de contato:</strong> Nome, e-mail e telefone precisam estar claramente identificados na parte superior do currículo — o ATS os procura nessa posição.</li>
      </ul>

      <h2>Erros que Fazem seu Currículo Ser Eliminado pelo ATS</h2>

      <h3>1. Usar Imagens com Texto</h3>
      <p>Se você colocou seu nome ou suas habilidades dentro de uma imagem (como um banner gráfico ou infográfico), o ATS não consegue ler esse conteúdo. Para ele, aquela parte do currículo simplesmente não existe.</p>

      <h3>2. Nomes de Seção Incomuns</h3>
      <p>"Minha Trajetória" no lugar de "Experiência Profissional" ou "O Que Eu Sei" no lugar de "Habilidades" confundem o ATS. Use títulos de seção padrão e reconhecíveis.</p>

      <h3>3. Formatação com Múltiplas Colunas Complexas</h3>
      <p>Layouts em duas ou três colunas, especialmente com caixas de texto flutuantes, podem ser lidos na ordem errada pelo ATS — misturando conteúdo de colunas diferentes e gerando texto sem sentido no banco de dados do recrutador.</p>

      <h3>4. Falta de Palavras-chave da Vaga</h3>
      <p>Este é o erro mais comum e mais eliminatório. Se a vaga pede "gestão de projetos" e no seu currículo está apenas "coordenação de equipes", o ATS pode não fazer essa correspondência e descartar seu perfil.</p>

      <h3>5. Fontes e Caracteres Especiais Excessivos</h3>
      ...
      <p>Sempre envie o currículo em <strong>.PDF</strong> gerado por um editor de texto (como o CurriculoGO) ou em <strong>.DOCX</strong>. PDFs escaneados de documentos físicos são essencialmente imagens — o ATS não consegue ler o texto.</p>

      <h2>Como Otimizar seu Currículo para ATS</h2>

      <h3>1. Espelhe as Palavras-chave da Vaga</h3>
      <p>Leia a descrição da vaga com atenção e identifique os termos técnicos, competências e ferramentas mencionados. Incorpore esses termos naturalmente no seu currículo — especialmente no resumo profissional e nas descrições de experiência.</p>
      <p><strong>Exemplo:</strong> Se a vaga pede "experiência com metodologias ágeis, Scrum e gestão de backlog", certifique-se de que essas palavras apareçam no seu currículo se você realmente tem essa experiência.</p>

      <h3>2. Use Títulos de Seção Padrão</h3>
      ...
      <p>Um layout de coluna única é o mais seguro para ATS. Se usar duas colunas (como nos templates do CurriculoGO), prefira designs que exportam o PDF com texto linear e sem caixas flutuantes. O CurriculoGO gera PDFs compatíveis com ATS exatamente por isso.</p>
      ...
      <h3>5. Inclua Variações dos Termos</h3>
      <p>Algumas ferramentas ATS não reconhecem sinônimos. Se a vaga menciona "SEO", inclua também "Otimização para Mecanismos de Busca". Se menciona "UI/UX", inclua também "design de interface". Cubra as bases sem exagerar.</p>
      ...
      <h2>Score ATS do CurriculoGO</h2>
      <p>O CurriculoGO possui uma ferramenta exclusiva de <strong>Score ATS com Inteligência Artificial</strong>. Ela analisa seu currículo e retorna:</p>
      <ul>
        ...
        <li><strong>Pontos fortes:</strong> o que está bem estruturado e otimizado</li>
      ...
      <p>Para acessar, crie ou edite seu currículo no CurriculoGO e clique no botão <strong>"Score ATS"</strong> no menu superior. A análise é feita pelo Google Gemini e leva apenas alguns segundos.</p>
