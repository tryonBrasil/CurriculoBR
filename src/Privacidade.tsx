        ...
        <div className="space-y-8">
          <section>
            <p className="text-slate-600 dark:text-slate-300 leading-relaxed">
              A sua privacidade é importante para nós. Esta Política descreve como o <strong>CurrículoGO</strong> coleta, usa e protege informações, em conformidade com a <strong>LGPD (Lei nº 13.709/2018)</strong>.
            </p>
          </section>
          <section>
            <h2 className="text-xl font-bold mb-3 text-slate-800 dark:text-white">1. Dados que Você Fornece</h2>
            <p className="text-slate-600 dark:text-slate-300 leading-relaxed">
              Os dados inseridos nos formulários (nome, e-mail, experiências, etc.) são processados <strong>exclusivamente no seu navegador</strong> e salvos no <code>localStorage</code> do seu dispositivo. Não são transmitidos nem armazenados em servidores do CurrículoGO.
            </p>
          </section>
          <section>
          ...
          <section>
            ...
            <div className="p-4 bg-blue-50 dark:bg-slate-800 rounded-lg border border-blue-100 dark:border-slate-700">
              <p className="font-semibold text-slate-800 dark:text-white">CurrículoGO</p>
